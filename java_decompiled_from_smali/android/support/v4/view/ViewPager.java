...
public class ViewPager extends ViewGroup {
    ...
    public class SavedState extends BaseSavedState {
        public static final Creator CREATOR = a.a(new cf());
        int a;
        Parcelable b;
        ClassLoader c;
    ...
    private void a(android.support.v4.view.bz r12, int r13, android.support.v4.view.bz r14) {
        /*
        r11 = this;
        r4 = 0;
    ...
    L_0x0034:
        r0 = r11.e;
        r0 = r0.get(r1);
        r0 = (android.support.v4.view.bz) r0;
    L_0x003c:
        r5 = r0.b;
    ...
    L_0x0157:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.view.ViewPager.a(android.support.v4.view.bz, int, android.support.v4.view.bz):void");
    }
    ...
    private void a(boolean z) {
        ...
        for (scrollX = 0; scrollX < this.e.size(); scrollX++) {
            bz bzVar = (bz) this.e.get(scrollX);
            if (bzVar.c) {
                bzVar.c = false;
                z3 = true;
            }
    ...
    private bz i() {
        ...
        while (i2 < this.e.size()) {
            int i3;
            bz bzVar2;
            bz bzVar3 = (bz) this.e.get(i2);
            bz bzVar4;
            if (obj != null || bzVar3.b == i + 1) {
                bzVar4 = bzVar3;
                i3 = i2;
                bzVar2 = bzVar4;
            } else {
    ...
    public boolean a(KeyEvent keyEvent) {
        ...
        switch (keyEvent.getKeyCode()) {
            ...
            case 22:
                return c(66);
            case 61:
                return VERSION.SDK_INT >= 11 ? s.a(keyEvent) ? c(2) : s.a(keyEvent, 1) ? c(1) : false : false;
            default:
                return false;
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.o > 0 && this.p != null && this.e.size() > 0 && this.h != null) {
            ...
            while (i4 < i2) {
                ...
                if (i4 == bzVar.b) {
                    f3 = (bzVar.e + bzVar.d) * ((float) width);
                    f2 = (bzVar.e + bzVar.d) + f;
                } else {
                    float b = this.h.b(i4);
                    f3 = (f2 + b) * ((float) width);
                    f2 += b + f;
        ...
        switch (motionEvent.getAction() & 255) {
            ...
            case e.MapAttrs_cameraBearing /*1*/:
                if (this.A) {
                    ...
                    a = (int) ao.a(velocityTracker, this.J);
                    this.y = true;
                    int clientWidth = getClientWidth();
                    int scrollX = getScrollX();
                    bz i = i();
                    a(a(i.b, ((((float) scrollX) / ((float) clientWidth)) - i.e) / i.d, a, (int) (z.c(motionEvent, z.a(motionEvent, this.J)) - this.H)), true, true, a);
                    this.J = -1;
                    j();
                    z = this.R.c() | this.Q.c();
                    break;
