...
public final class f {
    ...
    public static int a(Context context) {
        ...
        try {
            if (a(packageManager.getPackageInfo("com.android.vending", 64), a) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                return 9;
            }
            try {
                PackageInfo packageInfo = packageManager.getPackageInfo("com.google.android.gms", 64);
                if (a(packageInfo, r4) == null) {
    ...
    public static Dialog a(int i, Activity activity, int i2, OnCancelListener onCancelListener, int i3) {
        ...
        cp cpVar = new cp(activity, a(activity, i, i3), i2);
        String a = a((Context) activity, i);
        if (a != null) {
    ...
    public static Intent a(Context context, int i, int i2) {
        switch (i) {
            case e.MapAttrs_cameraBearing /*1*/:
            case e.MapAttrs_cameraTargetLat /*2*/:
                return a(i2) ? c(context) ? da.c("com.google.android.gms") : da.b("com.google.android.apps.bazaar") : da.b("com.google.android.gms");
            case e.MapAttrs_cameraTargetLng /*3*/:
    ...
    public static String b(Context context, int i, int i2) {
        ...
        switch (i) {
            case e.MapAttrs_cameraBearing /*1*/:
                string = a(context.getResources()) ? resources.getString(d.common_google_play_services_install_text_tablet) : resources.getString(d.common_google_play_services_install_text_phone);
                return a(i2) ? string + " (via Bazaar)" : string;
            case e.MapAttrs_cameraTargetLat /*2*/:
                string = resources.getString(d.common_google_play_services_update_text);
                return a(i2) ? string + " (via Bazaar)" : string;
            case e.MapAttrs_cameraTargetLng /*3*/:
