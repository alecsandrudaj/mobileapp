...
.method public getRequestMap(Landroid/content/Context;)Ljava/util/Map;
    ...
    .line 614
    const-class v1, Lcom/google/ads/doublec/DfpExtras;

    invoke-virtual {p0, v1}, Lcom/google/ads/AdRequest;->getNetworkExtras(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/google/ads/doublec/DfpExtras;

    .line 615
    if-eqz v1, :cond_c

    invoke-virtual {v1}, Lcom/google/ads/doublec/DfpExtras;->getExtras()Ljava/util/Map;
    ...
    .line 626
    invoke-virtual {v1}, Lcom/google/ads/doublec/DfpExtras;->getPublisherProvidedId()Ljava/lang/String;
